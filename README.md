# Vixen — E-commerce Microservice Platform
...
<p align="center">
  <img src="docs/architecture.svg" alt="Vixen System Architecture" width="100%"/>
</p>
...
3. **Database-per-Service** — Each service has its own MongoDB database (`Vixen_users`, `vixen_products`, `vixen_orders`, etc.) running on a shared MongoDB instance for true data isolation
